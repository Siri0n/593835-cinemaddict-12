...
/*!**********************!*\
  !*** ./src/const.js ***!
  \**********************/
/*! exports provided: EMOJI, COMMENTS_COUNT, GENRES_COUNT, POSTERS, NavType, SortType */
...
/* harmony import */ var _presenter_movie_list_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./presenter/movie-list.js */ "./src/presenter/movie-list.js");
...
// пользователь
Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_4__["render"])(siteHeaderElement, new _view_user_title_js__WEBPACK_IMPORTED_MODULE_2__["default"](), _utils_render_js__WEBPACK_IMPORTED_MODULE_4__["RenderPosition"].BEFOREEND);


// статистика в футоре
Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_4__["render"])(siteFooterElement, new _view_statistics_js__WEBPACK_IMPORTED_MODULE_3__["default"](filmsData), _utils_render_js__WEBPACK_IMPORTED_MODULE_4__["RenderPosition"].BEFOREEND);

const movieListPresenter = new _presenter_movie_list_js__WEBPACK_IMPORTED_MODULE_5__["default"](siteMainElement, siteFooterElement);
...
const generateDate = () => {
  ...
  return Object(_utils_js__WEBPACK_IMPORTED_MODULE_0__["getRandomInteger"])(minYearsGap, maxYearsGap);
};
...
/* harmony import */ var _view_films_section_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../view/films-section.js */ "./src/view/films-section.js");
/* harmony import */ var _view_no_films_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../view/no-films.js */ "./src/view/no-films.js");
/* harmony import */ var _view_films_list_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../view/films-list.js */ "./src/view/films-list.js");
/* harmony import */ var _view_film_card__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../view/film-card */ "./src/view/film-card.js");
/* harmony import */ var _view_film_details__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../view/film-details */ "./src/view/film-details.js");
...
/* harmony import */ var _view_film_extra_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../view/film-extra.js */ "./src/view/film-extra.js");
...
/* harmony import */ var _utils_film_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../utils/film.js */ "./src/utils/film.js");
...
class MovieList {
  constructor(siteMainElement, siteFooterElement) {
    ...
    this._currentNavType = _const_js__WEBPACK_IMPORTED_MODULE_0__["NavType"].DEFAULT;
    ...
    this._noFilmsSectionComponent = new _view_no_films_js__WEBPACK_IMPORTED_MODULE_4__["default"]();
    this._showMoreButtonComponent = new _view_show_more_button_js__WEBPACK_IMPORTED_MODULE_8__["default"]();
  ...
  init(dataFilmsArray, dataCommentsArray) {
    this._siteMainNavComponent = new _view_main_nav_js__WEBPACK_IMPORTED_MODULE_1__["default"](dataFilmsArray);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_11__["render"])(this._siteMainElement, this._siteMainNavComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_11__["RenderPosition"].BEFOREEND);
    this._siteMainNavComponent.setNavTypeChangeHandler(this._handleNavTypeChange);

    this._sortingComponent = new _view_sorting_js__WEBPACK_IMPORTED_MODULE_2__["default"]();
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_11__["render"])(this._siteMainElement, this._sortingComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_11__["RenderPosition"].BEFOREEND);
    this._sortingComponent.setSortTypeChangeHandler(this._handleSortTypeChange);

    this._filmsSectionComponent = new _view_films_section_js__WEBPACK_IMPORTED_MODULE_3__["default"]();
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_11__["render"])(this._siteMainElement, this._filmsSectionComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_11__["RenderPosition"].BEFOREEND);

    if (!dataFilmsArray) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_11__["render"])(this._filmsSectionComponent, this._noFilmsSectionComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_11__["RenderPosition"].BEFOREEND);
      return;
    }
  ...
  _renderCard(dataFilm, listContainerComponent) {
    const filmCardComponent = new _view_film_card__WEBPACK_IMPORTED_MODULE_6__["default"](dataFilm);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_11__["render"])(listContainerComponent, filmCardComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_11__["RenderPosition"].BEFOREEND);

    filmCardComponent.setHandler(() => {
      if (this.filmDetailsComponent) {
        Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_11__["remove"])(this.filmDetailsComponent);
      }

      this.filmDetailsComponent = new _view_film_details__WEBPACK_IMPORTED_MODULE_7__["default"](dataFilm, this._dataCommentsArray);
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_11__["render"])(this._siteFooterComponent, this.filmDetailsComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_11__["RenderPosition"].AFTEREEND);
  ...
  _renderExtra() {
    ...
    if (dataArrayRating.length > 0) {
      const extraSectionTopRatingComponent = new _view_film_extra_js__WEBPACK_IMPORTED_MODULE_9__["default"](`Top rated`);
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_11__["render"])(this._filmsSectionComponent, extraSectionTopRatingComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_11__["RenderPosition"].BEFOREEND);
      const filmsListTopRatingContainerComponent = new _view_films_list_container_js__WEBPACK_IMPORTED_MODULE_10__["default"]();
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_11__["render"])(extraSectionTopRatingComponent, filmsListTopRatingContainerComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_11__["RenderPosition"].BEFOREEND);
    ...
    if (dataArrayComment.length > 0) {
      const extraSectionMostCommentedComponent = new _view_film_extra_js__WEBPACK_IMPORTED_MODULE_9__["default"](`Most commented`);
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_11__["render"])(this._filmsSectionComponent, extraSectionMostCommentedComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_11__["RenderPosition"].BEFOREEND);
      const filmsListMostCommentedContainerComponent = new _view_films_list_container_js__WEBPACK_IMPORTED_MODULE_10__["default"]();
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_11__["render"])(extraSectionMostCommentedComponent, filmsListMostCommentedContainerComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_11__["RenderPosition"].BEFOREEND);
  ...
  _renderMainContent() {
    this._filmsListComponent = new _view_films_list_js__WEBPACK_IMPORTED_MODULE_5__["default"]();
    this._filmsListContainerComponent = new _view_films_list_container_js__WEBPACK_IMPORTED_MODULE_10__["default"]();
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_11__["render"])(this._filmsSectionComponent, this._filmsListComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_11__["RenderPosition"].AFTERBEGIN);
...
/*!***************************!*\
  !*** ./src/utils/film.js ***!
  \***************************/
/*! exports provided: compareYear, compareRating */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
  ...
  return (
    `<nav class="main-navigation">
      <div class="main-navigation__items">
        <a href="#all" class="main-navigation__item main-navigation__item--active" data-nav-type="${_const_js__WEBPACK_IMPORTED_MODULE_1__["NavType"].DEFAULT}">All movies</a>
        <a href="#watchlist" class="main-navigation__item" data-nav-type="${_const_js__WEBPACK_IMPORTED_MODULE_1__["NavType"].WATCHLIST}">Watchlist <span class="main-navigation__item-count">${watchlistAmount}</span></a>
        <a href="#history" class="main-navigation__item" data-nav-type="${_const_js__WEBPACK_IMPORTED_MODULE_1__["NavType"].HISTORY}">History <span class="main-navigation__item-count">${historyAmount}</span></a>
        <a href="#favorites" class="main-navigation__item" data-nav-type="${_const_js__WEBPACK_IMPORTED_MODULE_1__["NavType"].FAVORITES}">Favorites <span class="main-navigation__item-count">${favoritesAmount}</span></a>
      </div>
