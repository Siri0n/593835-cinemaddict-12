...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return ApiComment; });
/* harmony import */ var _model_comments_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../model/comments.js */ "./src/model/comments.js");
...
class ApiComment {
  ...
  getComments() {
    return this._load({url: `comments`})
      ...
      .then((comments) => comments.map(_model_comments_js__WEBPACK_IMPORTED_MODULE_0__["default"].adaptToClient));
  }
  ...
  updateComments(comment) {
    return this._load({
      url: `comments`,
      method: Method.PUT,
      body: JSON.stringify(_model_comments_js__WEBPACK_IMPORTED_MODULE_0__["default"].adaptToServer(comment)),
      headers: new Headers({"Content-Type": `application/json`})
    })
      .then(ApiComment.toJSON)
      .then(_model_comments_js__WEBPACK_IMPORTED_MODULE_0__["default"].adaptToClient);
  }
  ...
  addComment(comment) {
    ...
    return this._load({
      ...
      .then(ApiComment.toJSON)
      .then((response) => {
        return response.comments.map(_model_comments_js__WEBPACK_IMPORTED_MODULE_0__["default"].adaptToClient);
      });
  }
...
/* harmony import */ var _model_films_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../model/films.js */ "./src/model/films.js");
  ...
  getFilms() {
    if (Provider.isOnline()) {
      return this._api.getFilms()
        .then((films) => {
          const items = createStoreStructure(films.map(_model_films_js__WEBPACK_IMPORTED_MODULE_1__["default"].adaptToServer));
    ...
    return Promise.resolve(storeFilms.map(_model_films_js__WEBPACK_IMPORTED_MODULE_1__["default"].adaptToClient));
  }
  ...
  updateFilm(film) {
    if (Provider.isOnline()) {
      return this._api.updateFilm(film)
        .then((updatedFilm) => {
          this._store.setItem(updatedFilm.id, _model_films_js__WEBPACK_IMPORTED_MODULE_1__["default"].adaptToServer(updatedFilm));
          return updatedFilm;
        });
    }

    this._store.setItem(film.id, _model_films_js__WEBPACK_IMPORTED_MODULE_1__["default"].adaptToServer(Object.assign({}, film)));
  ...
  addFilm(film) {
    if (Provider.isOnline()) {
      return this._api.addFilm(film)
        .then((newFilm) => {
          this._store.setItem(newFilm.id, _model_films_js__WEBPACK_IMPORTED_MODULE_1__["default"].adaptToServer(newFilm));
          return newFilm;
        });
    }

    const localNewFilmId = Object(nanoid__WEBPACK_IMPORTED_MODULE_0__["nanoid"])();
    const localNewFilm = Object.assign({}, film, {id: localNewFilmId});

    this._store.setItem(localNewFilm.id, _model_films_js__WEBPACK_IMPORTED_MODULE_1__["default"].adaptToServer(localNewFilm));
...
/*!**********************!*\
  !*** ./src/const.js ***!
  \**********************/
/*! exports provided: GENRES, EMOJI, COMMENTS_COUNT, GENRES_COUNT, NavType, FilterType, SortType, UpdateType, EmojiType, UserAction, UserType, Keys */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
const GENRES = [`Film-Noir`, `Drama`, `Musical`, `Sci-Fi`, `Animation`, `Fantasy`, `Comedy`, `TV Series`];
const EMOJI = [`smile`, `sleeping`, `angry`, `puke`];
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _presenter_footer_statistic_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./presenter/footer-statistic.js */ "./src/presenter/footer-statistic.js");
/* harmony import */ var _presenter_main_nav_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./presenter/main-nav.js */ "./src/presenter/main-nav.js");
...
/* harmony import */ var _presenter_user_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./presenter/user.js */ "./src/presenter/user.js");
/* harmony import */ var _model_films_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./model/films.js */ "./src/model/films.js");
/* harmony import */ var _const_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./const.js */ "./src/const.js");
/* harmony import */ var _model_nav_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./model/nav.js */ "./src/model/nav.js");
...
const navModel = new _model_nav_js__WEBPACK_IMPORTED_MODULE_6__["default"]();
const filmsModel = new _model_films_js__WEBPACK_IMPORTED_MODULE_4__["default"]();
...
const api = new _api_api_js__WEBPACK_IMPORTED_MODULE_7__["default"](END_POINT, AUTHORIZATION);
...
const userPresenter = new _presenter_user_js__WEBPACK_IMPORTED_MODULE_3__["default"](siteHeaderElement, filmsModel);
const mainNavPresenter = new _presenter_main_nav_js__WEBPACK_IMPORTED_MODULE_1__["default"](siteMainElement, navModel, filmsModel);
const footerStatisticsPresenter = new _presenter_footer_statistic_js__WEBPACK_IMPORTED_MODULE_0__["default"](siteFooterElement, filmsModel);
const movieListPresenter = new _presenter_movie_list_js__WEBPACK_IMPORTED_MODULE_2__["default"](siteMainElement, siteFooterElement, navModel, filmsModel, apiWithProvider);
...
apiWithProvider.getFilms().then((films) => {
  filmsModel.setFilms(_const_js__WEBPACK_IMPORTED_MODULE_5__["UpdateType"].INIT, films);
});
...
class Nav extends _utils_observer_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor() {
    super();
    this._activeNav = _const_js__WEBPACK_IMPORTED_MODULE_1__["NavType"].ALL;
  }
...
class FilmDetails {
  ...
  init(film, model) {
    ...
    this._filmDetailsComponent = new _view_film_details_js__WEBPACK_IMPORTED_MODULE_1__["default"](this._film, this._commentsModel.getComments());
    ...
    if (prevDetailsComponent === null) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_0__["render"])(this._siteFooterComponent, this._filmDetailsComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].BEFOREEND);
      document.addEventListener(`keydown`, this._escKeyDownHandler);
      return;
    }

    if (prevDetailsComponent) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_0__["replace"])(this._filmDetailsComponent, prevDetailsComponent);
      document.addEventListener(`keydown`, this._escKeyDownHandler);
      return;
    }

    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_0__["remove"])(prevDetailsComponent);
  }

  destroy() {
    document.removeEventListener(`keydown`, this._escKeyDownHandler);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_0__["remove"])(this._filmDetailsComponent);
  }

  _handleFavoriteClick(data) {
    this._changeData(_const_js__WEBPACK_IMPORTED_MODULE_2__["UserAction"].UPDATE_FILM, _const_js__WEBPACK_IMPORTED_MODULE_2__["UpdateType"].PATCH, Object.assign({}, this._film, data));
  }
  ...
  _handleDeleteClick(comment) {
    this._api.deleteComment(comment)
      .then(() => {
        this._commentsModel.deleteComment(_const_js__WEBPACK_IMPORTED_MODULE_2__["UpdateType"].DELETE_COMMENT, comment);
      })
  ...
  _handleCommentSubmit(comment) {
    ...
    this._api.addComment(comment)
      .then((response) => {
        ...
        this._commentsModel.addComment(_const_js__WEBPACK_IMPORTED_MODULE_2__["UpdateType"].ADD_COMMENT, newCommnet);
      })
      .catch(() => {
...
/* harmony import */ var _utils_render_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/render.js */ "./src/utils/render.js");
/* harmony import */ var _const_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../const.js */ "./src/const.js");
/* harmony import */ var _film_details_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./film-details.js */ "./src/presenter/film-details.js");
...
/* harmony import */ var _model_comments_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../model/comments.js */ "./src/model/comments.js");
/* harmony import */ var _api_api_comment_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../api/api-comment.js */ "./src/api/api-comment.js");
...
class Film {
  constructor(siteFooterComponent, listContainerComponent, changeData, changeMode) {
    ...
    this._commentsModel = new _model_comments_js__WEBPACK_IMPORTED_MODULE_4__["default"]();
  ...
  init(film) {
    ...
    this._api = new _api_api_comment_js__WEBPACK_IMPORTED_MODULE_5__["default"](END_POINT, AUTHORIZATION, this._movieId);
    ...
    this._filmCardComponent = new _view_film_card_js__WEBPACK_IMPORTED_MODULE_3__["default"](this._film);
    ...
    if (prevCardComponent === null) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_0__["render"])(this._listContainerComponent, this._filmCardComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].BEFOREEND);
      return;
    }

    if (prevCardComponent) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_0__["replace"])(this._filmCardComponent, prevCardComponent);
      return;
    }

    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_0__["remove"])(prevCardComponent);
  }
  ...
  destroy() {
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_0__["remove"])(this._filmCardComponent);
  }

  _handleFavoriteClick() {
    this._changeData(_const_js__WEBPACK_IMPORTED_MODULE_1__["UserAction"].UPDATE_FILM, _const_js__WEBPACK_IMPORTED_MODULE_1__["UpdateType"].PATCH, Object.assign({}, this._film, {isFavorite: !this._film.isFavorite}));
  }

  _handleWatchedClick() {
    this._changeData(_const_js__WEBPACK_IMPORTED_MODULE_1__["UserAction"].UPDATE_FILM, _const_js__WEBPACK_IMPORTED_MODULE_1__["UpdateType"].PATCH, Object.assign({}, this._film, {isWatched: !this._film.isWatched, watchingDate: this._film.watchingDate}));
  }

  _handleWatchlistClick() {
    this._changeData(_const_js__WEBPACK_IMPORTED_MODULE_1__["UserAction"].UPDATE_FILM, _const_js__WEBPACK_IMPORTED_MODULE_1__["UpdateType"].PATCH, Object.assign({}, this._film, {isWatchlist: !this._film.isWatchlist}));
  }
  ...
  _handleCommentsEvent(updateType) {
    this._changeData(_const_js__WEBPACK_IMPORTED_MODULE_1__["UserAction"].UPDATE_FILM, updateType, Object.assign({}, this._film, {commentsCount: this._commentsModel.getComments().length}));
    this._detailsPresenter.init(this._film, this._commentsModel);
  }

  _showCardDetails() {
    this._detailsPresenter = new _film_details_js__WEBPACK_IMPORTED_MODULE_2__["default"](this._siteFooterComponent, this._changeData, this._changeMode, this._api);
    this._detailsPresenter.init(this._film, this._commentsModel);
...
/***/ "./src/presenter/footer-statistic.js":
/*!*******************************************!*\
  !*** ./src/presenter/footer-statistic.js ***!
  \*******************************************/
/*! exports provided: default */
...
class FooterStatistics {
  ...
  init() {
    ...
    this._footerComponent = new _view_footer_statistics_js__WEBPACK_IMPORTED_MODULE_1__["default"](this._filmsModel.getFilms());

    if (prevFooterComponent === null) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_0__["render"])(this._footerContainerComponent, this._footerComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].BEFOREEND);
      return;
    }

    if (prevFooterComponent) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_0__["replace"])(this._footerComponent, prevFooterComponent);
      return;
    }

    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_0__["remove"])(prevFooterComponent);
  }

  destroy() {
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_0__["remove"])(this._footerComponent);
  }
...
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return Nav; });
/* harmony import */ var _view_main_nav_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../view/main-nav.js */ "./src/view/main-nav.js");
/* harmony import */ var _utils_render_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/render.js */ "./src/utils/render.js");
/* harmony import */ var _const_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../const.js */ "./src/const.js");
/* harmony import */ var _utils_nav_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../utils/nav.js */ "./src/utils/nav.js");
...
class Nav {
  ...
  init() {
    ...
    this._mainNavComponent = new _view_main_nav_js__WEBPACK_IMPORTED_MODULE_0__["default"](navs, this._currentNav);
    this._mainNavComponent.setNavTypeChangeHandler(this._handleNavTypeChange);

    if (prevMainNavComponent === null) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["render"])(this._navContainerComponent, this._mainNavComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_1__["RenderPosition"].BEFOREEND);
      return;
    }

    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["replace"])(this._mainNavComponent, prevMainNavComponent);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["remove"])(prevMainNavComponent);
  }
  ...
  _handleNavTypeChange(navType) {
    ...
    if (navType === `stats`) {
      this._navModel.setNav(_const_js__WEBPACK_IMPORTED_MODULE_2__["UpdateType"].STATS, navType);
      return;
    }

    this._navModel.setNav(_const_js__WEBPACK_IMPORTED_MODULE_2__["UpdateType"].MAJOR, navType);
  }
  ...
  _getNavs() {
    ...
    return [
      {
        type: _const_js__WEBPACK_IMPORTED_MODULE_2__["NavType"].ALL,
        name: `All movies`,
        count: _utils_nav_js__WEBPACK_IMPORTED_MODULE_3__["nav"][_const_js__WEBPACK_IMPORTED_MODULE_2__["NavType"].ALL](films).length
      },
      {
        type: _const_js__WEBPACK_IMPORTED_MODULE_2__["NavType"].WATCHLIST,
        name: `Watchlist`,
        count: _utils_nav_js__WEBPACK_IMPORTED_MODULE_3__["nav"][_const_js__WEBPACK_IMPORTED_MODULE_2__["NavType"].WATCHLIST](films).length
      },
      {
        type: _const_js__WEBPACK_IMPORTED_MODULE_2__["NavType"].HISTORY,
        name: `History`,
        count: _utils_nav_js__WEBPACK_IMPORTED_MODULE_3__["nav"][_const_js__WEBPACK_IMPORTED_MODULE_2__["NavType"].HISTORY](films).length
      },
      {
        type: _const_js__WEBPACK_IMPORTED_MODULE_2__["NavType"].FAVORITES,
        name: `Favorites`,
        count: _utils_nav_js__WEBPACK_IMPORTED_MODULE_3__["nav"][_const_js__WEBPACK_IMPORTED_MODULE_2__["NavType"].FAVORITES](films).length
      }
    ];
  }
}
...
/* harmony import */ var _const_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../const.js */ "./src/const.js");
/* harmony import */ var _utils_nav_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../utils/nav.js */ "./src/utils/nav.js");
/* harmony import */ var _view_films_list_container_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../view/films-list-container.js */ "./src/view/films-list-container.js");
/* harmony import */ var _view_film_extra_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../view/film-extra.js */ "./src/view/film-extra.js");
...
/* harmony import */ var _view_films_section_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../view/films-section.js */ "./src/view/films-section.js");
/* harmony import */ var _view_no_films_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../view/no-films.js */ "./src/view/no-films.js");
/* harmony import */ var _statistics_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./statistics.js */ "./src/presenter/statistics.js");
/* harmony import */ var _view_films_list_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../view/films-list.js */ "./src/view/films-list.js");
/* harmony import */ var _view_sorting_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../view/sorting.js */ "./src/view/sorting.js");
...
/* harmony import */ var _film_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./film.js */ "./src/presenter/film.js");
...
class MovieList {
  constructor(siteMainElement, siteFooterElement, navModel, filmsModel, api) {
    ...
    this._noFilmsComponent = new _view_no_films_js__WEBPACK_IMPORTED_MODULE_8__["default"]();
    this._loadingComponent = new _view_loading_js__WEBPACK_IMPORTED_MODULE_12__["default"]();

    this._commenExtraId = [];
    this._ratingExtraId = [];

    this._extraSectionTopRatingComponent = new _view_film_extra_js__WEBPACK_IMPORTED_MODULE_5__["default"](`Top rated`);
    this._extraSectionMostCommentedComponent = new _view_film_extra_js__WEBPACK_IMPORTED_MODULE_5__["default"](`Most commented`);
  ...
  _renderSorting() {
    ...
    this._sortingComponent = new _view_sorting_js__WEBPACK_IMPORTED_MODULE_11__["default"](this._currentSortType);
    this._sortingComponent.setSortTypeChangeHandler(this._handleSortTypeChange);

    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["render"])(this._filmsSectionComponent, this._sortingComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_1__["RenderPosition"].BEFOREBEGIN);
  }

  _renderNoFilmsComponent() {
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["render"])(this._filmsSectionComponent, this._noFilmsComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_1__["RenderPosition"].BEFOREEND);
  }

  _getFilms() {
    const navType = this._navModel.getNav();
    const films = this._filmsModel.getFilms();
    const navFilms = _utils_nav_js__WEBPACK_IMPORTED_MODULE_3__["nav"][navType](films);

    switch (this._currentSortType) {
      case _const_js__WEBPACK_IMPORTED_MODULE_2__["SortType"].DATE:
        return navFilms.sort(_utils_film_js__WEBPACK_IMPORTED_MODULE_0__["compareYear"]);
      case _const_js__WEBPACK_IMPORTED_MODULE_2__["SortType"].RATING:
        return navFilms.sort(_utils_film_js__WEBPACK_IMPORTED_MODULE_0__["compareRating"]);
    }
    return navFilms;
  }
  ...
  _handleViewAction(actionType, updateType, update) {
    switch (actionType) {
      case _const_js__WEBPACK_IMPORTED_MODULE_2__["UserAction"].UPDATE_FILM:
  ...
  _handleModelEvent(updateType, item) {
    switch (updateType) {
      case _const_js__WEBPACK_IMPORTED_MODULE_2__["UpdateType"].PATCH:
        ...
        break;
      case _const_js__WEBPACK_IMPORTED_MODULE_2__["UpdateType"].MINOR:
        this._clearMainContent();
        this._renderMainContent();
        break;
      case _const_js__WEBPACK_IMPORTED_MODULE_2__["UpdateType"].MAJOR:
        this._clearMainContent({resetRenderedCardCount: true, resetSortType: true});
        this._renderMainContent();
        break;
      case _const_js__WEBPACK_IMPORTED_MODULE_2__["UpdateType"].STATS:
        this._clearMainContent({resetRenderedCardCount: true, resetSortType: true});
        this._renderStatistics();
        break;
      case _const_js__WEBPACK_IMPORTED_MODULE_2__["UpdateType"].DELETE_COMMENT:
        if (this._commenExtraId.includes(item.id)) {
          this._filmExtraCommentPresenter[item.id].init(item);
        }
        if (this._ratingExtraId.includes(item.id)) {
        ...
        break;
      case _const_js__WEBPACK_IMPORTED_MODULE_2__["UpdateType"].ADD_COMMENT:
        if (this._commenExtraId.includes(item.id)) {
          this._filmExtraCommentPresenter[item.id].init(item);
        }
        if (this._ratingExtraId.includes(item.id)) {
        ...
        break;
      case _const_js__WEBPACK_IMPORTED_MODULE_2__["UpdateType"].INIT:
        this._isLoading = false;
        Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["remove"])(this._loadingComponent);
        this._renderMainContent();
        break;
    }
  }
  ...
  _renderShowMoreButton() {
    ...
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["render"])(this._filmsListComponent, this._showMoreButtonComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_1__["RenderPosition"].BEFOREEND);
  }

  _renderCard(film, place) {
    const filmPresenter = new _film_js__WEBPACK_IMPORTED_MODULE_13__["default"](this._siteFooterComponent, place, this._handleViewAction, this._handleModeChange);
  ...
  _renderExtraRating() {
    ...
    filmsRating = filmsRating.sort(_utils_film_js__WEBPACK_IMPORTED_MODULE_0__["compareRating"]).slice(0, CARDS_EXTRA_AMOUNT);

    if (filmsRating[0].rating > 0) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["render"])(this._filmsSectionComponent, this._extraSectionTopRatingComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_1__["RenderPosition"].BEFOREEND);
      this._filmsListTopRatingContainerComponent = new _view_films_list_container_js__WEBPACK_IMPORTED_MODULE_4__["default"]();
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["render"])(this._extraSectionTopRatingComponent, this._filmsListTopRatingContainerComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_1__["RenderPosition"].BEFOREEND);

      filmsRating.forEach((film) => {
        this._ratingExtraId.push(film.id);

        const filmPresenter = new _film_js__WEBPACK_IMPORTED_MODULE_13__["default"](this._siteFooterComponent, this._filmsListTopRatingContainerComponent, this._handleViewAction, this._handleModeChange);
        filmPresenter.init(film);
  ...
  _renderExtraCommented() {
    ...
    filmsCommented = filmsCommented.sort(_utils_film_js__WEBPACK_IMPORTED_MODULE_0__["compareComments"]).slice(0, CARDS_EXTRA_AMOUNT);

    if (filmsCommented[0].comments.length > 0) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["render"])(this._filmsSectionComponent, this._extraSectionMostCommentedComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_1__["RenderPosition"].BEFOREEND);
      this._filmsListMostCommentedContainerComponent = new _view_films_list_container_js__WEBPACK_IMPORTED_MODULE_4__["default"]();
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["render"])(this._extraSectionMostCommentedComponent, this._filmsListMostCommentedContainerComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_1__["RenderPosition"].BEFOREEND);

      filmsCommented.forEach((film) => {
        this._commenExtraId.push(film.id);

        const filmPresenter = new _film_js__WEBPACK_IMPORTED_MODULE_13__["default"](this._siteFooterComponent, this._filmsListMostCommentedContainerComponent, this._handleViewAction, this._handleModeChange);
        filmPresenter.init(film);
  ...
  _renderLoading() {
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["render"])(this._filmsSectionComponent, this._loadingComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_1__["RenderPosition"].BEFOREEND);
  }
  ...
  _clearMainContent({resetRenderedCardCount = false, resetSortType = false} = {}) {
    ...
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["remove"])(this._sortingComponent);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["remove"])(this._noFilmsComponent);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["remove"])(this._filmsSectionComponent);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["remove"])(this._showMoreButtonComponent);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["remove"])(this._filmsListTopRatingContainerComponent);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["remove"])(this._filmsListMostCommentedContainerComponent);
  ...
  _renderMainContent() {
    ...
    this._filmsSectionComponent = new _view_films_section_js__WEBPACK_IMPORTED_MODULE_7__["default"]();
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["render"])(this._siteMainElement, this._filmsSectionComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_1__["RenderPosition"].BEFOREEND);
    ...
    if (this._filmsListComponent !== null) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["remove"])(this._filmsListComponent);
    }
    ...
    this._filmsListComponent = new _view_films_list_js__WEBPACK_IMPORTED_MODULE_10__["default"]();
    this._filmsListContainerComponent = new _view_films_list_container_js__WEBPACK_IMPORTED_MODULE_4__["default"]();
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["render"])(this._filmsSectionComponent, this._filmsListComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_1__["RenderPosition"].AFTERBEGIN);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["render"])(this._filmsListComponent, this._filmsListContainerComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_1__["RenderPosition"].BEFOREEND);
  ...
  _renderStatistics() {
    this._staticticsPresenter = new _statistics_js__WEBPACK_IMPORTED_MODULE_9__["default"](this._siteMainElement, this._filmsModel);
...
/* harmony import */ var _model_filter_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../model/filter.js */ "./src/model/filter.js");
/* harmony import */ var _const_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../const.js */ "./src/const.js");
/* harmony import */ var _utils_filters_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../utils/filters.js */ "./src/utils/filters.js");
...
class Statistics {
  constructor(siteMainElement, filmsModel) {
    ...
    this._siteMainElement = siteMainElement;
    this._filterModel = new _model_filter_js__WEBPACK_IMPORTED_MODULE_2__["default"]();
  ...
  init() {
    ...
    this._staticticsComponent = new _view_statistics_js__WEBPACK_IMPORTED_MODULE_1__["default"](filters, this._currentFilter);
    this._staticticsComponent.setFilterTypeChangeHandler(this._handleFilterTypeChange);

    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_0__["render"])(this._siteMainElement, this._staticticsComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].BEFOREEND);
  }

  destroy() {
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_0__["remove"])(this._staticticsComponent);
  }
    ...
    return [
      {
        ...
        name: `All-time`,
        movie: _utils_filters_js__WEBPACK_IMPORTED_MODULE_4__["filter"][_const_js__WEBPACK_IMPORTED_MODULE_3__["FilterType"].ALL](films)
      },
      {
        type: _const_js__WEBPACK_IMPORTED_MODULE_3__["FilterType"].TODAY,
        name: `Today`,
        movie: _utils_filters_js__WEBPACK_IMPORTED_MODULE_4__["filter"][_const_js__WEBPACK_IMPORTED_MODULE_3__["FilterType"].TODAY](films)
      },
      {
        type: _const_js__WEBPACK_IMPORTED_MODULE_3__["FilterType"].WEEK,
        name: `Week`,
        movie: _utils_filters_js__WEBPACK_IMPORTED_MODULE_4__["filter"][_const_js__WEBPACK_IMPORTED_MODULE_3__["FilterType"].WEEK](films)
      },
      {
        type: _const_js__WEBPACK_IMPORTED_MODULE_3__["FilterType"].MONTH,
        name: `Month`,
        movie: _utils_filters_js__WEBPACK_IMPORTED_MODULE_4__["filter"][_const_js__WEBPACK_IMPORTED_MODULE_3__["FilterType"].MONTH](films)
      },
      {
        type: _const_js__WEBPACK_IMPORTED_MODULE_3__["FilterType"].YEAR,
        name: `Year`,
        movie: _utils_filters_js__WEBPACK_IMPORTED_MODULE_4__["filter"][_const_js__WEBPACK_IMPORTED_MODULE_3__["FilterType"].YEAR](films)
      }
    ];
  }
}
...
/* harmony import */ var _utils_render_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/render.js */ "./src/utils/render.js");
/* harmony import */ var _const_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../const.js */ "./src/const.js");
/* harmony import */ var _view_user_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../view/user.js */ "./src/view/user.js");
...
class User {
  ...
  init() {
    ...
    this._userComponent = new _view_user_js__WEBPACK_IMPORTED_MODULE_2__["default"](userType);

    if (prevUserComponent === null) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_0__["render"])(this._userContainerComponent, this._userComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].BEFOREEND);
      return;
    }

    if (prevUserComponent) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_0__["replace"])(this._userComponent, prevUserComponent);
      return;
    }

    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_0__["remove"])(prevUserComponent);
  }

  destroy() {
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_0__["remove"])(this._userComponent);
  }
  ...
  _getUser() {
    ...
    if (watchedFilms <= FilmsAmount.NOVICE) {
      userType = _const_js__WEBPACK_IMPORTED_MODULE_1__["UserType"].NOVICE;
    }

    if (watchedFilms > FilmsAmount.NOVICE && watchedFilms <= FilmsAmount.FAN) {
      userType = _const_js__WEBPACK_IMPORTED_MODULE_1__["UserType"].FAN;
    }

    if (watchedFilms >= FilmsAmount.BUFF) {
      userType = _const_js__WEBPACK_IMPORTED_MODULE_1__["UserType"].BUFF;
    }
...
/*!***************************!*\
  !*** ./src/utils/film.js ***!
  \***************************/
/*! exports provided: compareYear, compareRating, compareComments, formatRunTime, formatDateOfRelease, formatDateOfProduction */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "compareComments", function() { return compareComments; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "formatRunTime", function() { return formatRunTime; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "formatDateOfRelease", function() { return formatDateOfRelease; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "formatDateOfProduction", function() { return formatDateOfProduction; });
/* harmony import */ var moment__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! moment */ "./node_modules/moment/moment.js");
/* harmony import */ var moment__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(moment__WEBPACK_IMPORTED_MODULE_0__);


const compareYear = (filmA, filmB) => {
...
const formatDateOfRelease = (date) => {
  if (!(date instanceof Date)) {
    date = new Date(date);
  }
...
const formatDateOfProduction = (date) => {
  if (!(date instanceof Date)) {
    date = new Date(date);
  }
...
const filter = {
  ...
  [_const__WEBPACK_IMPORTED_MODULE_0__["FilterType"].TODAY]: (films) => films.filter((film) => compareToday(film)),
  [_const__WEBPACK_IMPORTED_MODULE_0__["FilterType"].WEEK]: (films) => films.filter((film) => compareWeek(film)),
  [_const__WEBPACK_IMPORTED_MODULE_0__["FilterType"].MONTH]: (films) => films.filter((film) => compareMonth(film)),
  [_const__WEBPACK_IMPORTED_MODULE_0__["FilterType"].YEAR]: (films) => films.filter((film) => compareYear(film)),
};
...
const nav = {
  [_const__WEBPACK_IMPORTED_MODULE_0__["NavType"].STATISTICS]: (films) => films,
  [_const__WEBPACK_IMPORTED_MODULE_0__["NavType"].ALL]: (films) => films,
  [_const__WEBPACK_IMPORTED_MODULE_0__["NavType"].WATCHLIST]: (films) => films.filter((film) => film.isWatchlist),
  [_const__WEBPACK_IMPORTED_MODULE_0__["NavType"].HISTORY]: (films) => films.filter((film) => film.isWatched),
  [_const__WEBPACK_IMPORTED_MODULE_0__["NavType"].FAVORITES]: (films) => films.filter((film) => film.isFavorite),
};
...
/*!*********************************!*\
  !*** ./src/utils/statistics.js ***!
  \*********************************/
/*! exports provided: sortedGenres, topGenre, userRank, totalDuration */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "sortedGenres", function() { return sortedGenres; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "topGenre", function() { return topGenre; });
...
const userRank = (data) => {
  ...
  if (data.length <= FilmsAmount.NOVICE) {
    userType = _const_js__WEBPACK_IMPORTED_MODULE_0__["UserType"].NOVICE;
  }

  if (data.length > FilmsAmount.NOVICE && data.length <= FilmsAmount.FAN) {
    userType = _const_js__WEBPACK_IMPORTED_MODULE_0__["UserType"].FAN;
  }

  if (data.length >= FilmsAmount.BUFF) {
    userType = _const_js__WEBPACK_IMPORTED_MODULE_0__["UserType"].BUFF;
  }
...
const totalDuration = (data) => {
  ...
  if (data.length === 0) {
    ...
    data.forEach((item) => {
      totalH += +moment__WEBPACK_IMPORTED_MODULE_1___default()(item.runtime).format(`HH`);
      totalM += +moment__WEBPACK_IMPORTED_MODULE_1___default()(item.runtime).format(`MM`);
    });
...
const createFilmCardTemplate = (film = {}) => {
  ...
  const dateOfProductionTemplate = Object(_utils_film_js__WEBPACK_IMPORTED_MODULE_0__["formatDateOfProduction"])(dateOfProduction);
  ...
  const filmRunTime = Object(_utils_film_js__WEBPACK_IMPORTED_MODULE_0__["formatRunTime"])(runtime);
...
class FilmCard extends _smart_js__WEBPACK_IMPORTED_MODULE_2__["default"] {
  constructor(data) {
    super();
    this._data = data;
...
/* harmony import */ var _utils_comment_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/comment.js */ "./src/utils/comment.js");
...
const createCommentTemplate = (comment = {}) => {
  ...
  const commentDate = Object(_utils_comment_js__WEBPACK_IMPORTED_MODULE_0__["formatCommentDate"])(date);
...
/* harmony import */ var _utils_film_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/film.js */ "./src/utils/film.js");
/* harmony import */ var _film_comment__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./film-comment */ "./src/view/film-comment.js");
/* harmony import */ var _const_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../const.js */ "./src/const.js");
...
const createFilmDetailsTemplate = (data = {}, comments) => {
  ...
  if (!isOffline && window.navigator.onLine) {
    filmComments = comments.slice(0, comments.length).map(_film_comment__WEBPACK_IMPORTED_MODULE_1__["createCommentTemplate"]).join(``);
  }

  const commnetAmount = comments.length;
  const filmRunTime = Object(_utils_film_js__WEBPACK_IMPORTED_MODULE_0__["formatRunTime"])(runtime);
  const fimDateOfRelease = Object(_utils_film_js__WEBPACK_IMPORTED_MODULE_0__["formatDateOfRelease"])(dateOfRelease);

  const commentDescription = ``;
  let currentEmoji = emoji ? emoji : _const_js__WEBPACK_IMPORTED_MODULE_2__["EmojiType"].SMILE;
  ...
  const createEmojiTemplate = () => {
    return (
      ...
      `<div class="film-details__emoji-list">
          <input class="film-details__emoji-item visually-hidden" name="comment-emoji" type="radio" id="emoji-smile" value="smile" ${currentEmoji === _const_js__WEBPACK_IMPORTED_MODULE_2__["EmojiType"].SMILE ? `checked ` : ``} ${isOffline === true ? `disabled` : ``}>
          <label class="film-details__emoji-label" for="emoji-smile">
            <img src="./images/emoji/smile.png" width="30" height="30" alt="emoji">
          </label>

          <input class="film-details__emoji-item visually-hidden" name="comment-emoji" type="radio" id="emoji-sleeping" value="sleeping" ${currentEmoji === _const_js__WEBPACK_IMPORTED_MODULE_2__["EmojiType"].SLEEPING ? `checked` : ``} ${isOffline === true ? `disabled` : ``}>
          <label class="film-details__emoji-label" for="emoji-sleeping">
            <img src="./images/emoji/sleeping.png" width="30" height="30" alt="emoji">
          </label>

          <input class="film-details__emoji-item visually-hidden" name="comment-emoji" type="radio" id="emoji-puke" value="puke" ${currentEmoji === _const_js__WEBPACK_IMPORTED_MODULE_2__["EmojiType"].PUKE ? `checked` : ``} ${isOffline === true ? `disabled` : ``}>
          <label class="film-details__emoji-label" for="emoji-puke">
            <img src="./images/emoji/puke.png" width="30" height="30" alt="emoji">
          </label>

          <input class="film-details__emoji-item visually-hidden" name="comment-emoji" type="radio" id="emoji-angry" value="angry" ${currentEmoji === _const_js__WEBPACK_IMPORTED_MODULE_2__["EmojiType"].ANGRY ? `checked` : ``} ${isOffline === true ? `disabled` : ``}>
          ...
          <section class="film-details__comments-wrap">
            ...
            <div class="film-details__new-comment">
              ...
              <label class="film-details__comment-label">
                <textarea class="film-details__comment-input" placeholder="Select reaction below and write comment here" name="comment" ${isOffline === true ? `disabled` : ``}>${he__WEBPACK_IMPORTED_MODULE_4___default.a.encode(commentDescription)}</textarea>
              </label>
              ${createEmojiTemplate()}
            </div>
          </section>
...
class FilmCardDetails extends _smart__WEBPACK_IMPORTED_MODULE_3__["default"] {
  ...
  _keyDownHandler(event) {
    ...
    const codes = [_const_js__WEBPACK_IMPORTED_MODULE_2__["Keys"].CONTROL, _const_js__WEBPACK_IMPORTED_MODULE_2__["Keys"].ENTER];
...
/*!******************************!*\
  !*** ./src/view/main-nav.js ***!
  \******************************/
/*! exports provided: createMainNavigationTemplate, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
const createMainNavigationTemplate = (navItems, currentNavType) => {
...
class ShowMoreButton extends _smart_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor() {
    super();
...
const renderDurationTemplate = (movies) => {
  const time = Object(_utils_statistics_js__WEBPACK_IMPORTED_MODULE_1__["totalDuration"])(movies);
...
const renderChart = (statisticCtx, movie) => {
  const amountWatchedGenres = Object(_utils_statistics_js__WEBPACK_IMPORTED_MODULE_1__["sortedGenres"])(movie);
...
const createStatisticsTemplate = (filtersItems, currentFilter) => {
  ...
  const rankTemplate = Object(_utils_statistics_js__WEBPACK_IMPORTED_MODULE_1__["userRank"])(allFilterItem.movie);
  const topGenreTemplate = Object(_utils_statistics_js__WEBPACK_IMPORTED_MODULE_1__["topGenre"])(currentFilterItem.movie);
...
class User extends _smart_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
